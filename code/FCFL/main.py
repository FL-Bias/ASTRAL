...
parser.add_argument('--warmup', type=str, default="no", help="eps weight for specific eps")
...
parser.add_argument('--eval_epoch', type = int, default=1, help="iteras for printing the loss info")
...
parser.add_argument('--data_dir', type = str, default="../../astral-datasets/version_FCFL", help="iteras for printing the loss info")
...
args.validation_dir = os.path.join(args.data_dir, args.dataset, "valid")
