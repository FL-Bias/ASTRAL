...
from models import ResnetPytorch, MLPPytorch
...
class DE_alpha_search(object):
    ...
    def __init__(self,
        ...
        self.calls = 0
        first_w = copy.deepcopy(self.Theta[0])
    ...
    def compute_bias_computed_global_model(self,vars):
        ...
        #print('compute_bias_computed_global_model')
        if isinstance(self.global_model_variable, ResnetPytorch) or isinstance(self.global_model_variable, MLPPytorch)  :
#            print('resnet')
            w_avg = copy.deepcopy(self.Theta[0])
 ...
 #       print('finish compute_bias_computed_global_model')
 #       print(nc)
        #print([ww/n for ww in nc])
        try:
